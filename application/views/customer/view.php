				...
				<div class="table-responsive mt-3 mb-3">
					<table class="table table-borderless table-hover" id="masteruser" width="100%" cellspacing="0">
						...
						<tbody>
							...
							<!--Edit Modal-->
							<div class="modal fade" id="editModal<?=encrypt_url($dt->IdPelanggan) ?>" tabindex="-1" role="dialog" aria-labelledby="editModal" aria-hidden="true">
													...
													<div class="form-group col-md-9">
														...
														<select class="form-control <?php echo form_error('fpaketedit')?'is-invalid':''?>" name="fpaketedit">
															...
															<?php foreach ($paket as $dt) :?>
																<option value="<?=$dt->IdPaket?>" <?=$pkt == "$dt->IdPaket" ? "selected" : ''?>><?=ucfirst($dt->NamaPaket);?></option>
															<?php endforeach ?>
														</select>
														<div class="invalid-feedback">
